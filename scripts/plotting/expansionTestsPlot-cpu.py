...
dfDiff = pd.DataFrame({
    ...
    "Algorithm":algorithm,
    "CPU Time Per Lookahead":cpuPerLookahead
})
...
for instance in resultDirs:
    ...
    makeDifferencePlot(11, 8, "CPU Time Per Lookahead", "Algorithm Cost - A* Cost", instanceDataDiffExp, 0.35, "Algorithm", limits, algorithmsExpC, "CPU Time Per Lookahead", "Algorithm Cost - A* Cost", "../../../plots/Experiment2CDifference" + instance + ".pdf")
