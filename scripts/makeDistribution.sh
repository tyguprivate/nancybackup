...
g++ -g -std=c++11 -static ../cpp/fastAStar-inverse/*.cc ../cpp/fastAStar-inverse/*.hpp -o ../../build_release/tiles-inverse
#g++ -g -std=c++11 -static ../cpp/fastAStar-inverse/test.cpp ../cpp/fastAStar-inverse/fatal.* -o ../../build_release/tiles-inverse-test
...
#chmod a+x ../../build_release/tiles-inverse-test
